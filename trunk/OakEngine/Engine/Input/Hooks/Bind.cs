...
namespace Oak.Engine.Scripting
{
    class Bind : IInterpretable
    {
        ...
        private void bindKeyboard(string[] command)
        {
            ...
            if (keyToBind == "reset")
            {
                //Game1.kb.Clear(); //TODO rework this
                Interpreter.runFirst("run defaultKBBind");
                return;
            }
            else if (keyToBind == "clear") {
                //Game1.kb.Clear(); //TODO rework this... somehow
                return;
            }
            ...
            //else
            //Game1.kb.KeyToAction[keyToBind] = sb.ToString(); //TODO work into the input engine somehow...
        }
